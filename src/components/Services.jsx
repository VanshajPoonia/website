  ...
  return (
    <Section id="how-to-use">
      <div className="container">
        <Heading
          title="Revolutionary platform made for small and medium business."
          text="KreativVantage helps you to expand your market via technology"
        />
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                <h4 className="h4 mb-4">Chat and Call Support</h4>
                <p className="body-2 mb-[2rem] text-n-3">
                  One of the fastest response time to customers
                </p>
